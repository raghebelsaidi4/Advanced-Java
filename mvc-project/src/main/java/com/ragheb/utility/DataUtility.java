...
public class DataUtility {
    ...
    public static String getString(String val) {
        if (DataValidation.isNotNull(val)) {
            return val.trim();
        } else {
            return val;
        }
    ...
    public static int getInt(String val) {
        if (DataValidation.isInteger(val)) {
     ...
     * @return
     */
    public static Timestamp getTimestamp(long cdt) {
        Timestamp timeStamp = null;
        try {
            timeStamp = new Timestamp(cdt);
        } catch (Exception e) {
            return null;
        }
        return timeStamp;
